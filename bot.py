...
def language_handler(message):
    ...
    AAG5z--eYoWDpek1XeoY3eyXtdlsOhI0Et4'd, texts['language'], reply_markup=language_menu())
...
print("🤖 Gmail Factory Bot is Running - Final Syntax Fixed Version with CAPTCHA!")
